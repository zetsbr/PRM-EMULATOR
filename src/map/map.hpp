...
enum _sp {
	...
	SP_ADD_HEAL_RATE,SP_ADD_HEAL2_RATE, SP_EQUIP_ATK, SP_DEL_SPIRITCHARM, SP_ADD_SPIRITCHARM, //1090-1092
	...
	SP_WEAPON_SUBSIZE, SP_REDUCE_COOLDOWN, SP_REDUCE_COOLDOWN_ON_DEBUFF, SP_BOUNCE, SP_AUTOATK_CAP, SP_ASPD_CAP, SP_SPLASH_SKILL,  // 2102-2107
