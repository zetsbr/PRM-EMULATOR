...
#define SCRIPT_CONSTANTS_HPP
	...
	export_constant(SC_FLAMESPINNER_T);
	export_constant(SC_DEADLYROSE_T);
...
/// @APIHOOK_START(EFST_CONST)
	...
	export_constant(EFST_FLAMESPINNER_T);
	export_constant(EFST_DEADLYROSE_T);
	export_constant(EFST_GUARDROCK_T);
	export_constant(EFST_FROSTSPINNER_T);
	export_constant(EFST_BLOODROSE);
/// @APIHOOK_END
